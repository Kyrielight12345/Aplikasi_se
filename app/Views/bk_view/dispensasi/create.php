            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Tambah Dispensasi</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('dispensasi/index'); ?>">Kelola Dispensasi</a></li>
            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <?php echo form_open_multipart('dispensasi/store'); ?>
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title student-info">Informasi Dispensasi <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                </div>
                                ...
                                <div class="col-12 col-lg-8">
                                    <div class="form-group local-forms">
                                        ...
                                        <textarea name="keterangan" cols="39" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
