...
use App\Controllers\surat_keluar;

echo view('kepsek_view/partials_kepsek/header') ?> <?php echo view('kepsek_view/partials_kepsek/sidebar') ?> <div class="page-wrapper">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-footer">
                                <a href="<?php echo base_url('kep_surat_keluar'); ?>" class="btn btn-outline-info float-right">Back</a>
                            </div>
                            <div class="card-footer">
                                <a href="<?php echo base_url('kep_surat_keluar/update/' . $surat_keluar['id_surat']); ?>" class="btn btn-outline-info float-right">Setujui</a>
                            </div>
                        </div>
                    </div>
                </div>
