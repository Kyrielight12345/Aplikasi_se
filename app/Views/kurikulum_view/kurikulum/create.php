            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Tambah Kurikulum</h3>
                        <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <?php echo form_open_multipart('kurikulum/store'); ?>
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" type="text" placeholder="Isikan Kode Kurikulum" name="id_kurikulum" value="<?php  //echo $inputs['kode_kurikulum']; }
                                                                                                                                                ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" type="text" placeholder="Isikan kompetensi dasar" name="kompetensi_dasar" value="<?php  //echo $inputs['nama_kurikulum']; }
                                                                                                                                                        ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-lg-8">
                                    <div class="form-group local-forms">
                                        ...
                                        <textarea name="deskripsi" cols="39" rows="5"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
