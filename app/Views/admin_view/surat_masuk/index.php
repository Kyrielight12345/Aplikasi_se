                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    ...
                                    <a href="<?php echo base_url('surat_masuk/create_surat'); ?>" class="btn btn-outline-primary me-2"><i class="fas fa-plus"></i> Tambah</a>
                                ...
                                <tbody>
                                    <?php foreach ($surat_masuk as $key => $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="<?php echo base_url('surat_masuk/show_masuk/' . $row['id_surat']); ?>" class="btn btn-sm btn-info">
                                                        <i class="fa fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo base_url('surat_masuk/edit/' . $row['id_surat']); ?>" class="btn btn-sm btn-success">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <a href="<?php echo base_url('surat_masuk/delete/' . $row['id_surat']); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin surat ini?');">
