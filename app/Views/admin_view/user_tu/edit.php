        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card comman-shadow">
                    <div class="card-body">
                        <?php echo form_open_multipart('user_tu/update'); ?>
                        <div class="card">
                            <div class="card-body">
                                <?php
                                // if (!empty($inputs)){
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control" type="text" placeholder="Isikan username" name="username" value="<?php echo $users['username']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>password <span class="login-danger">*</span></label>
                                            <input class="form-control" type="text" placeholder="Isikan password" name="password" value="<?php echo $users['password']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <select name="akses" class="form-control select">
                                                ...
                                                <option <?php echo $users['akses'] == "guru" ? "selected" : "";
                                                        ?> value="guru">guru</option>
                                                <option <?php echo $users['akses'] == "admin" ? "selected" : "";
                                                        ?> value="admin">admin</option>
                                                <option <?php echo $users['akses'] == "kepsek" ? "selected" : "";
                                                        ?> value="kepsek">kepsek</option>
                                                <option <?php echo $users['akses'] == "bk" ? "selected" : "";
                                                        ?> value="bk">bk</option>
                                                <option <?php echo $users['akses'] == "kurikulum" ? "selected" : "";
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            <label>nama </label>
                                            <input class="form-control" type="text" placeholder="Isikan nama " name="nama" value="<?php echo $users['nama']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-12">
