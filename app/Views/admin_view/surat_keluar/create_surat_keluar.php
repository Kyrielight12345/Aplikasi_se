            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="students.html">Surat Keluar</a></li>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card comman-shadow">
                    <div class="card-body">
                        <?php echo form_open_multipart('surat_keluar/store'); ?>
                        <div class="card">
                            <div class="card-body">
                                <?php
                                // if (!empty($inputs)){
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <h5 class="form-title student-info">Informasi Surat Keluar <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-4">
                                        <div class="form-group local-forms">
                                            ...
                                            <input class="form-control datetimepicker" type="date" placeholder="DD-MM-YYYY" name="tgl_keluar" value="<?php  //echo $inputs['tgl_keluar']; }
                                                                                                                                                        ?>">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-4">
