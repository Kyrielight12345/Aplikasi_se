            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Tambah Ruang</h3>
                        <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                ...
                <div class="col-sm-12">
                    <div class="card comman-shadow">
                        <div class="card-body">
                            <?php echo form_open_multipart('ruang/store'); ?>
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title student-info">Ruang <span><a href="javascript:;"><i class="feather-more-vertical"></i></a></span></h5>
                                </div>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" type="text" placeholder="Isikan Nama Ruang" name="nama_ruang" value="<?php  //echo $inputs['kompetensi_dasar']; }
                                                                                                                                            ?>">
                                    </div>
                                </div>
                                <div class="col-12">
